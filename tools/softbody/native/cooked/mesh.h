...
public:
  ...
  // Load trusted, version-matched PhysX cooking output without recooking it.
  static std::shared_ptr<PhysxConvexMesh>
  FromCookedData(std::vector<uint8_t> const &data);
