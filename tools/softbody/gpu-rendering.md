...
The later [render-update optimization](render-performance.md) removes particle
CPU readback and individual entity updates from batched CUDA rendering. CPU and
single-view rendering retain their entity-pose path. The render-only
